...
let botname = '*_ｄ1�7 EKSYARBOT 0.1 ｄ1�7 冬_*' //NAMA BOT
let lolkey = '923693a1e95d5525b720c22b'
...
let ownername = '*_ｄ1�7 EKSYARBOT ✄1�7 ｣_*' //NAMA OWNER
let owner = '6289699805903' // NOMOR OWNER
let symbol = '*☄1�7*'
let faketeks = `*_ｄ1�7 EKSYARBOT 0.1 ｄ1�7 冬_*` 
...
const prefix = /^[°•τ1�7÷×¶∆£¢€¥®℄1�7=|~!#$%^&.?/\\©^z+*@,;]/.test(cmd) ? cmd.match(/^[°•τ1�7÷×¶∆£¢€¥®℄1�7=|~!#$%^&.?/\\©^z+*,;]/gi) : '.'          	
...
case 8: jamss = "Morning ☄1�7︄1�7"; break;
case 9: jamss = "Morning ☄1�7︄1�7"; break;
case 10: jamss = "Morning ☄1�7︄1�7"; break;
case 11: jamss = "Afternoon 🌞"; break;
case 12: jamss = "Zuhur 🌞"; break;
case 13: jamss = "Afternoon 🌞"; break;
case 14: jamss = "Afternoon 🌞"; break;
case 15: jamss = "Asr 🌞"; break;
case 16: jamss = "Afternoon ☄1�7︄1�7"; break;
